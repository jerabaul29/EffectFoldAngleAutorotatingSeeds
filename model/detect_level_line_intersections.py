...
# from https://stackoverflow.com/questions/17416268/how-to-find-all-the-intersection-points-between-two-contour-set-in-an-efficient
...
def detect_intersections(contour1, contour2):
    xi = np.array([])
    yi = np.array([])
