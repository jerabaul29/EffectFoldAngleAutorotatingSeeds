...
#'''
position_points = generate_vertical_positions_table(0, 550, 50, verbose=0)     # do it in mm
selected_positions_pixels = generate_data_calibration_click(path + '../' + folder + '/', 'referansefoto080917.png', verbose=0)
...
for ind_case in range(nbr_cases):
    ...
    (list_pos_seed, list_width_data_seed, list_true_wing_tip) = \
        process_folder_process(path_to_images, dict_images,
                               list_images, number_of_images, tuple_shape_image,
                               image_start=0, number_of_images_to_analyse=-1, verbose=0, debug=False)
